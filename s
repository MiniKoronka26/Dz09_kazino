...
void size_b(int size, ring_queue& b) {
    for (int i = 0; i < size; i++) {
        b.push(i);
    }
}

void kazino3(ring_queue b1, ring_queue b2, ring_queue b3) {

    b1.print();
    b2.print();
    b3.print();

    if (b1.top() == b2.top() && b1.top() == b3.top())
        cout << "you win!";
    else
        cout << "sorry(";
}
